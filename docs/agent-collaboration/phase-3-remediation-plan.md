...
| Task ID | 问题 | 来源 | Owner | 分支 | 修复范围 | 验收标准 | 阻塞生产化 |
|---|---|---|---|---|---|---|---|
...
| FIX-004 | Safety Guard 仅覆盖 Agent 链路，RAG 主链路无安全检查 | Security P0-4 | A2 | fix/safety-guard-rag | `rag_service.py` 或 Java 层 | RAG 主链路也应用 Safety Guard 检查 | ✅ 是 |
